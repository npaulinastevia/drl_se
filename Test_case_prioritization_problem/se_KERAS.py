        ...
        if first_round:
            ...
            if algo.upper()=='DQN':
                ...
                model.compile(
                    ...
                    optimizer="adam",
                    metrics=["accuracy"])
                policy = LinearAnnealedPolicy(EpsGreedyQPolicy(), attr='eps', value_max=1., value_test=.05,value_min=0.02, nb_steps=100)
            ...
            tp_agen.fit(env, nb_steps=10, visualize=False, verbose=2)
